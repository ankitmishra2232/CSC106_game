...
public class EffectsController {
	 ...
	 * takes color to be saved.
	 * returns true if it was possible to save the color, false otherwise.
	 */
	 ...
	 * returns  string that contains the color.
	 */
	 ...
	 * returns a string that contains the color.
	 */
