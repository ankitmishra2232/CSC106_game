...
public class Match implements Game {
	...
	private final static int N_CARDS_EACH = 7;
	 ...
	 * returns true if the number of players is in the valid interval, false 
	 * otherwise.
	 */
	 ...
	 * reported.
	 * takes name: the name of the card that will be played.
	 * returns true if the operation was successful, false otherwise.
	 */
	 ...
	 * takes advertUno true if the player says 'UNO', false otherwise.
	 */
	 ...
	 * returns true if the player has no more cards, false otherwise.
	 */
